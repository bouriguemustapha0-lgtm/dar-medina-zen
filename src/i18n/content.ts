...
const fr = {
  ...
  home: {
    ...
    amenities: [
      ...
      {
        title: "Conciergerie",
        text: "Transferts aéroport depuis l'aéroport Marrakech-Ménara (15 km) : 20 $, réservation de guides et de tables, dépôt de bagages.",
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Oui. Un transfert privé depuis l'aéroport Marrakech-Ménara, situé à environ 15 minutes en voiture, est disponible sur demande pour 20 $. Le chauffeur dépose les hôtes à l'entrée du derb et un membre de l'équipe porte les bagages jusqu'à la porte.",
      },
      {
...
const en: typeof fr = {
  ...
  home: {
    ...
    amenities: [
      ...
      {
        title: "Concierge",
        text: "Airport transfers from Marrakech-Menara airport (15 km): $20, guides and restaurant bookings, luggage storage.",
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. A private transfer from Marrakech-Menara airport, about 15 minutes away by car, is available on request for $20. The driver drops guests at the entrance of the derb and a team member carries the luggage to the door.",
      },
      {
